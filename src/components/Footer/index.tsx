  ...
  return (
    <footer className="bg-[#1D4E89] py-12 text-white text-sm md:text-base border-t-2 border-[#B22234]">
      ...
      <div className="text-gray-300 text-center">
        <p>
        <a href="https://www.google.com/maps?q=Bondegatan+13,+116+23+Stockholm" className='hover:underline' target="_blank" rel="noopener noreferrer">
          Bondegatan 13, 116 23 Stockholm
        </a>
        </p>
        <p>
        <a href="tel:+4686400271" className="hover:underline transition-colors duration-300">
          08 640 02 71
        </a>
        </p>
    </div>
        ...
        <div className="flex justify-center md:justify-end space-x-6">
          <a href="https://www.instagram.com/explore/locations/343401515524376/recos-chicken-and-waffles/" className="hover:text-stone-950 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
